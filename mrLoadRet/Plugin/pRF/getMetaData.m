...
switch mod
    ...
    case'somato'
        ...
        overlaySpec = {
            {'name','r2'}, ...
            {'name','prefDigit','range',[1 3],'clip',[1 3], 'colormapType', 'normal', 'colormap' ,rainbow_colors(256)}, ...
            {'name','prefPD','range',[1 3],'clip',[1 3], 'colormapType', 'normal', 'colormap' ,rainbow_colors(256)}, ...
