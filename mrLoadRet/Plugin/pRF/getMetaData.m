...
switch mod
    ...
    case'somato'
        ...
        overlaySpec = {
            {'name','r2'}, ...
            {'name','prefDigit','range',[1 4],'clip',[1 4], 'colormapType', 'normal', 'colormap' ,rainbow_colors(256)}, ...
            {'name','prefPD','range',[1 4],'clip',[1 4], 'colormapType', 'normal', 'colormap' ,rainbow_colors(256)}, ...
            {'name','rfHalfWidth','range',[0 50],'clip',[0 inf], 'colormapType', 'normal', 'colormap' ,pink(256)}, ...
            };
